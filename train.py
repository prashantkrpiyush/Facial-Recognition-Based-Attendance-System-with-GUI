...
window.title("Attendance DataBase")
...
path = "/home/prashant/Face-Recognition-Based-Attendance-System/register.jpg"

#Creates a Tkinter-compatible photo image, which can be used everywhere Tkinter expects an image object.
img = ImageTk.PhotoImage(Image.open("/home/prashant/Face-Recognition-Based-Attendance-System/register.jpg"))
...
cv_img = cv2.imread("/home/prashant/Face-Recognition-Based-Attendance-System/register.jpg")
...
def TakeImages():        
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        harcascadePath = "/home/prashant/Face-Recognition-Based-Attendance-System/haarcascade_frontalface_default.xml"
        ...
        while(True):
            ...
            for (x,y,w,h) in faces:
                ...
                cv2.imwrite("/home/prashant/Face-Recognition-Based-Attendance-System/TrainingImage/ "+name +"."+Id +'.'+ str(sampleNum) + ".jpg", gray[y:y+h,x:x+w])
                #display the frame
        ...
        row = [Id , name]
        with open('/home/prashant/Face-Recognition-Based-Attendance-System/StudentDetails/StudentDetails.csv','a+') as csvFile:
...
def TrainImages():
    ...
    harcascadePath = "/home/prashant/Face-Recognition-Based-Attendance-System/haarcascade_frontalface_default.xml"
    detector =cv2.CascadeClassifier(harcascadePath)
    faces,Id = getImagesAndLabels("/home/prashant/Face-Recognition-Based-Attendance-System/TrainingImage")
    recognizer.train(faces, np.array(Id))
    recognizer.save("/home/prashant/Face-Recognition-Based-Attendance-System/Trainner.yml")
...
def TrackImages():
    ...
    recognizer.read("/home/prashant/Face-Recognition-Based-Attendance-System/Trainner.yml")
    harcascadePath = "/home/prashant/Face-Recognition-Based-Attendance-System/haarcascade_frontalface_default.xml"
    faceCascade = cv2.CascadeClassifier(harcascadePath);    
    df=pd.read_csv("/home/prashant/Face-Recognition-Based-Attendance-System/StudentDetails/StudentDetails.csv")
    cam = cv2.VideoCapture(0)
    ...
    while True:
        ...
        for(x,y,w,h) in faces:
            ...
            if(conf > 75):
                ...
                cv2.imwrite("/home/prashant/Face-Recognition-Based-Attendance-System/ImagesUnknown/Image"+str(noOfFile) + ".jpg", im[y:y+h,x:x+w])            
    ...
    fileName="/home/prashant/Face-Recognition-Based-Attendance-System/Attendance/Attendance_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"
...
copyWrite.insert("insert", "Developed by Prashant Kumar Piyush")
